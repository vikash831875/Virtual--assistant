  ...
  const {serverUrl,userData,setUserData} = useContext(userDataContext)
    ...
    return (
        <div className='w-full h-[100vh] bg-cover flex justify-center items-center'
            ...
            <form className='w-[90%] h-[600px] max-w-[500px] bg-[#0000003] backdrop-blur shadow-lg flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
                ...
                <p className='text-white text-[18px]'>
                    ...
                    <span className='text-black cursor-pointer' onClick={() => navigate("/signup")}>
                        Sign Up
                    </span>
                </p>
